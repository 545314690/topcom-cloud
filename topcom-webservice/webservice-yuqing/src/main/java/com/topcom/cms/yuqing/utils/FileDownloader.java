...
import static com.topcom.cms.yuqing.utils.FileServer.filepath;
...
public class FileDownloader {
    ...
    public FileDownloader(String filename, String type, HttpServletRequest request, HttpServletResponse response) {
